...
public class WorkspaceBoardState
{
    ...
    public int SelectAllPiecesOnActiveSurface(TableSession? session)
    {
    ...
    public IReadOnlyList<PieceInstance> GetRenderedPiecesForBoard(TableSession? session, BoardVisibilityOptions visibility)
    {
    ...
    public bool ClearHiddenSelections(TableSession? session, BoardVisibilityOptions visibility)
    {
        if (SelectedPieceIds.Count == 0)
        {
            return false;
    ...
    public PieceInstance GetSelectedPieceOrThrow(TableSession? session)
    {
