    ...
    public class SnapshotImportApplyWorkflowService
    {
        ...
        public SnapshotImportApplyResponse ImportAndApply(string json, SnapshotImportApplyContext context, SnapshotImportApplyPolicy policy)
        {
            ...
            try
            {
                ...
                {
                    var policyDeniedPendingScenarioTitle = intent.OperationKind == SnapshotImportApplyOperationKind.CreateVttScenarioFromImport
                        ? (intent.Payload as VttScenario)?.Title
                        : null;
                    ...
                    return new SnapshotImportApplyResponse
                    {
                        ...
                        ResultingVttSession = context.CurrentVttSession,
                        PendingVttScenarioTitle = policyDeniedPendingScenarioTitle,
                ...
                var pendingVttScenarioTitle = intent.OperationKind == SnapshotImportApplyOperationKind.CreateVttScenarioFromImport
                    ? applyResult.PendingVttScenarioPlan?.ScenarioTitle ?? (intent.Payload as VttScenario)?.Title
                    : null;
                ...
                return new SnapshotImportApplyResponse
                {
                    ...
                    ResultingVttSession = applyResult.ResultingVttSession,
                    PendingVttScenarioTitle = pendingVttScenarioTitle,
                    PendingVttScenarioPlan = applyResult.PendingVttScenarioPlan,
        ...
        private static bool IsAllowedByPolicy(SnapshotImportApplyIntent intent, SnapshotImportApplyPolicy policy)
        {
            ...
            {
                SnapshotImportApplyOperationKind.ReplaceVttSession => policy.AllowReplaceVttSession,
                SnapshotImportApplyOperationKind.CreateVttScenarioFromImport => policy.AllowCreateVttScenarioFromImport,
                _ => true
            };
        }
            ...
            SnapshotImportFailureStage failureStage)
        {
            return new SnapshotImportApplyResponse
            {
                ...
                FormatKind = null,
                OperationKind = null,
                ResultingVttSession = null,
                PendingVttScenarioTitle = null,
                PendingVttScenarioPlan = null,
                Message = null,
